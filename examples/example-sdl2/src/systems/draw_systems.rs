        ...
        .build(
            ...
            (draw_boxes_query, draw_circles_query)| {
                draw_context.with_canvas(|canvas, coordinate_system_helper| {
                    ...
                    let viewport_size_in_pixels = glam::Vec2::new(drawable_size.width as f32, drawable_size.height as f32);
