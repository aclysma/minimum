...
pub fn update_input_resource(schedule: &mut legion::systems::Builder) {
    schedule.add_system(SystemBuilder::new("input end frame")
...
pub fn input_reset_for_next_frame(schedule: &mut legion::systems::Builder) {
    schedule.add_system(SystemBuilder::new("input end frame")
        .write_resource::<InputResource>()
        .build(|_, _, input, _| {
            input.end_frame();
